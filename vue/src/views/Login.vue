...
<template>
  <div style="height: 100vh; overflow: hidden; background-color: aliceblue;position: relative;">
    <div style="display: flex;width: 100%;height: 7%; background-color: rgba(65, 105, 225,.1);
      padding: 15px 30px; color: dodgerblue; font-size: 20px; overflow: hidden;">
      校园交友平台
    </div>
    <div style="position: absolute;bottom: 0;top: 0%;">
      <img src="../assets/bg.jpg" alt="" style="width: 100%; margin-top: 50px;">
    </div>
    <div style="display: flex; width: 25%; margin: 150px auto; background-color: white;
